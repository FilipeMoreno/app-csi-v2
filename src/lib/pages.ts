...
export function getPages(pathname: string): Group[] {
	return [
			...
			menus: [
				{
					...
					label: 'Chamados',
					active: pathname.includes('/suporte/chamados'),
					icon: Headset,
					submenus: [],
				},
				{
					href: '/suporte/ordem-servico',
					label: 'Ordem de Serviço',
					active: pathname.includes('/suporte/ordem-servico'),
					icon: NotepadText,
					submenus: [],
				},
				{
					href: '/suporte/equipamentos',
					label: 'Equipamentos',
					active: pathname.includes('/suporte/equipamentos'),
		...
		},
		{
			...
			menus: [
				{
					href: '/agendamentos/informatica',
					label: 'Informática',
					active: pathname.includes('/agendamentos/informatica'),
					icon: Clock,
					submenus: [],
				},
			],
